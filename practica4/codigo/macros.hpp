...
#define CLEAR_SCREEN       "\33[2J" //!< Borra la pantalla

#define CLEAR_REST_OF_LINE   "\33[K"  //!< Borra hasta el final de línea

#define RESET	    "\e[0m"  //!< desactiva 
#define INTENSITY   "\e[1m"  //!< intesidad
#define FAINT       "\e[2m"  //!< apenas visible
#define ITALIC      "\e[3m"  //!< itálica, cursiva

#define UNDERLINE   "\e[4m"  //!< subrayado
#define BLINK       "\e[5m"  //!< parpadeo

#define INVERSE     "\e[7m"  //!< inverso
